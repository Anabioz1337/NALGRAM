...
public struct ExperimentalUISettings: Codable, Equatable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.hideSponsoredMessages = try container.decodeIfPresent(Bool.self, forKey: "hideSponsoredMessages") ?? false
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(self.hideSponsoredMessages, forKey: "hideSponsoredMessages")
